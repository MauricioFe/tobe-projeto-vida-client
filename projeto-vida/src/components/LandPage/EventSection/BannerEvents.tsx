  ...
  const eventList: Array<Event> = [
    {
      ...
      description:
        'Oferecemos aos alunos a semana do empreendedor para vivênciarem na prática as rotinas empresariais, a partir de workshops e dinâmicas',
    ...
    },
    {
      ...
      description:
        'Uma semana de workshop com conteúdos, palestras e jogos voltados para o aprendizado do ingês',
